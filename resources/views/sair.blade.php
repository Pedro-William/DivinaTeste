...
<head>
    ...
    <title>Login Finalizado - Divina Essência</title>
...
<div class="container-principal">
    <div class="breadcrumb">
        <a href="home.html">Home</a> / <span>Login Finalizado</span>
    </div>

    <section class="o-login-finished-message">
        <h1 class="a-section-title">SEU LOGIN FOI FINALIZADO</h1>
    </section>
</div>
