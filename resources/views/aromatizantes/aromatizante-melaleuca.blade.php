...
<head>
    ...
    <title>Aromatizador  Melaleuca - Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/aroma-melaleuca.png" alt="Aromatizador de Melaleuca embalagem Divina Essência"
                    class="a-main-product-image">
            </div> 


            <div class="m-product-info">
                <h1 class="a-product-title">Aromatizador de Melaleuca</h1>
                <p class="a-product-price">R$ 36,90</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Purificação Poderosa: A Melaleuca é conhecida por suas propriedades que ajudam a limpar
                            profundamente o ar, sendo ideal para ambientes que necessitam de higiene e proteção.</li>
                        <li>Aroma de Limpeza: Seu cheiro fresco, herbal e penetrante elimina odores indesejados e
                            confere uma sensação imediata de ambiente renovado e purificado</li>
                        <li>Fortalecimento do Ambiente: Traz uma atmosfera de proteção, clareza e vigor, promovendo um
                            espaço mais saudável para respirar.</li>
                        <li>Fórmula com óleos essenciais puros, ideal para difusores ou sprays de ambiente.
                        </li>

                    </ul>

                    <p class="a-product-summary">Use o Aromatizante de Melaleuca em ambientes fechados, banheiros ou
                        áreas com pouca ventilação para garantir uma purificação intensa. Seu aroma canforado e herbal
                        limpa e renova o ar, deixando o espaço com uma sensação de higiene e proteção natural.
                ...
                <div class="m-buy-options">
                    ...
                    <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="20">
                    Comprar
                </button> 
                </div>
            </div>
