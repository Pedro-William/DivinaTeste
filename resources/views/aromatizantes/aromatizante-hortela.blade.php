...
<head>
    ...
    <title>Aromatizador  Hortelã- Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/aroma-hortela.png" alt="Aromatizador de Hortelã com embalagem Divina Essência"
            ...
            <div class="m-product-info">
                <h1 class="a-product-title">Aromatizador de Hortelã</h1>
                <p class="a-product-price">R$ 35,00</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Foco e Concentração: O aroma mentolado e penetrante da Hortelã é um poderoso estimulante, ajudando a despertar a mente e a aumentar a produtividade.</li>
                        <li>Refrescância Respiratória: Proporciona uma sensação imediata de vias aéreas livres e um frescor revigorante que purifica e renova o ar do ambiente.</li>
                        <li>Combate à Fadiga: Ideal para afastar o cansaço, a sonolência e a sensação de "cabeça pesada", trazendo leveza e vitalidade.</li>
                        <li>Fórmula com óleos essenciais puros, ideal para difusores ou sprays de ambiente.
                        </li>

                    </ul>


                    <p class="a-product-summary">Use o Aromatizante de Hortelã na mesa de trabalho, carro ou ambientes de estudo para um impulso de energia e clareza. Seu aroma canforado e fresco desobstrui não só o ar, mas também a mente, deixando o espaço com uma sensação de limpeza e foco intenso.
                ...
                <div class="m-buy-options">
                    ...
                    <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="18">
                    Comprar
                </button> 
                </div>
            </div>
