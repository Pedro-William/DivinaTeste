...
<head>
    ...
    <title>Aromatizador Cintronela - Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/aroma-citronela.png" alt="Aromatizador de Cintronela com embalagem Divina Essência"
            ...
            <div class="m-product-info">
                <h1 class="a-product-title">Aromatizador de Cintronela</h1>
                <p class="a-product-price">R$ 32,40</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Proteção Natural: O aroma da Citronela é mundialmente conhecido por ser um repelente
                            natural, ideal para afastar insetos e garantir mais conforto em áreas abertas.</li>
                        <li>Aroma de Frescor: Possui um perfume cítrico, fresco e intenso que purifica o ar,
                            neutralizando odores e deixando o ambiente com uma sensação de limpeza.</li>
                        <li>Revigorante Suave: Ajuda a clarear a mente e a promover a vitalidade, sendo ótimo para
                            ambientes que pedem energia e otimismo.</li>
                        <li>Fórmula com óleos essenciais puros, ideal para difusores ou sprays de ambiente.
                        </li>

                    </ul>

                    <p class="a-product-summary">Use o Aromatizante de Citronela para proteger e refrescar seu
                        ambiente. Perfeito para varandas, áreas gourmet, ou para manter o frescor da casa, ele
                        preenche o ar com um aroma limpo, vibrante e funcional, garantindo mais tranquilidade ao ar
                        livre e em casa.</p>
                </div>
                ...
                <div class="m-buy-options">
                    ...
                    <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="17">
                    Comprar
                </button> 
                </div>
            </div>
