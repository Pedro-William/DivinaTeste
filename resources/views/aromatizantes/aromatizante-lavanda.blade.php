    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/aroma-lavanda.png" alt="Aromatizador de Lavanda com embalagem Divina Essência"
            ...
            <div class="m-product-info">
                <h1 class="a-product-title">Aromatizador de Lavanda</h1>
                ...
                <div class="o-product-description">
                    ...
                    <ul class="m-benefits-list">
                        <li>Paz e Serenidade: O aroma floral e suave da Lavanda é o mais tradicional para acalmar o
                            sistema nervoso, dissolvendo a tensão e a agitação mental.</li>
                        <li>Sono de Qualidade: Ajuda a criar um ambiente propício para o descanso, facilitando a
                            transição para um sono profundo e reparador, sem interrupções.</li>
                        <li>Harmonia do Lar: Traz uma sensação imediata de conforto, aconchego e pureza, ideal para
                            pacificar o ambiente após um dia longo e estressante.</li>
                    ...
                    <p class="a-product-summary">Use o Aromatizante de Lavanda em quartos, salas de estar ou no seu
                        cantinho de leitura para criar um santuário de tranquilidade. Aplique antes de deitar ou em
                        momentos de estresse para envolver o ambiente em uma nuvem de calma reconfortante e bem-estar.
                ...
                <div class="m-buy-options">
                    ...
                    <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="19">
                    Comprar
                </button> 
                </div>
            </div>
