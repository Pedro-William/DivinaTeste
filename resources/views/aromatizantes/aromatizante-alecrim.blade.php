...
<head>
    ...
    <title>Aromatizador Alecrim- Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/aroma-alecrim.png" alt="Aromatizador de Alecrim com embalagem Divina Essência"
                    class="a-main-product-image">
            </div>

            <div class="m-product-info">
                <h1 class="a-product-title">Aromatizador de Alecrim</h1>
                <p class="a-product-price">R$ 33,70</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Estímulo da Mente: O Alecrim é um potente tônico mental, auxiliando a melhorar o foco, a
                            concentração e
                            a memória.</li>
                        <li>Energia Revigorante: Seu aroma herbal e canforado proporciona um despertar imediato,
                            combatendo o
                            cansaço e a fadiga mental e física.</li>
                        <li>Clareza e Ânimo: Cria uma atmosfera de otimismo e vitalidade, ideal para clarear os
                            pensamentos e
                            promover um ambiente ativo.</li>
                    ...
                    <p class="a-product-summary">Use o Aromatizante de Alecrim para transformar qualquer espaço em um
                        ambiente de trabalho ou estudo.
                        Aplique na sua mesa, escritório ou sala de aula para uma dose de foco, energia e clareza que
                        dura o dia
                        todo, purificando e revitalizando o ar.</p>
                </div>
                ...
                <div class="m-buy-options">
                    ...
                    <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="13">
                    Comprar
                </button> 
                </div>
            </div>
