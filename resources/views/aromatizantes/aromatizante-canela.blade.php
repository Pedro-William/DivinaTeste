...
<head>
    ...
    <title>Aromatizador Canela- Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/aroma-canela.png" alt="Aromatizador de Canela com embalagem Divina Essência"
                    class="a-main-product-image">
            </div> 

            <div class="m-product-info">
                <h1 class="a-product-title">Aromatizador de Canela</h1>
                <p class="a-product-price">R$ 31,00</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Calor e Aconchego: O aroma da Canela é instantaneamente reconfortante e quente, ideal para criar uma sensação de lar, especialmente em dias frios.</li>
                        <li>Estímulo Energético: Sua fragrância picante e doce atua como um tônico suave, promovendo o ânimo, a clareza e combatendo a lentidão.</li>
                        <li>Atmosfera de Prosperidade: A Canela é tradicionalmente usada para atrair boa sorte, prosperidade e vitalidade para o ambiente</li>
                        <li>Fórmula com óleos essenciais puros, ideal para difusores ou sprays de ambiente.
                        </li>

                    </ul>

                    <p class="a-product-summary">Use o Aromatizante de Canela para preencher o ambiente com um calor estimulante e acolhedor. É perfeito para a cozinha, sala de estar, ou em qualquer espaço onde você queira um aroma envolvente que traga ânimo, conforto e uma sensação de abundância.</p>
                </div> 
                <div class="m-buy-options">
                    ...
                    <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="15">
                    Comprar
                </button> 
                </div>
            </div>
