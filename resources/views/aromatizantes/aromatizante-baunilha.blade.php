...
<head>
    ...
    <title>Aromatizador Baunilha- Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/aroma-baunilha.png" alt="Aromatizador de Baunilha com embalagem Divina Essência"
            ...
            <div class="m-product-info">
                <h1 class="a-product-title">Aromatizador de Baunilha</h1>
                <p class="a-product-price">R$ 40,00</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Conforto Emocional Profundo: O aroma doce e envolvente da baunilha age como um abraço olfativo, promovendo acolhimento, bem-estar e alívio de sentimentos de ansiedade ou solidão.</li>
                        <li>Atmosfera de Aconchego e Paz: Cria instantaneamente um ambiente calmo e hospitaleiro, ideal para o relaxamento, a meditação ou para tornar o seu lar um verdadeiro refúgio após um longo dia.</li>
                        <li>Alegria e Suavidade: Sua fragrância está ligada a memórias afetivas positivas, ajudando a elevar o humor e a promover uma sensação de contentamento e tranquilidade natural.</li>
                        <li>Fórmula com óleos essenciais puros, ideal para difusores ou sprays de ambiente. </li>

                    </ul>

                    <p class="a-product-summary">Use o Aromatizante de Baunilha para injetar calma e doçura em qualquer espaço. Aplique no quarto, sala de estar ou cantinho de leitura para criar um ambiente de aconchego, segurança e paz. É o toque suave que acalma a mente e transforma o seu dia a dia.</p>
                </div> 
                ...
                <div class="m-buy-options">
                    ...
                    <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="14">
                    Comprar
                </button> 
                </div>
            </div>
