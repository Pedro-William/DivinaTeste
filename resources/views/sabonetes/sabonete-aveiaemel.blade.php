...
<head>
    ...
    <title>Sabonete Aveia e Mel- Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/sbnt-aveiamel.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Sabonete Aveia e Mel</h1>
            <p class="a-product-price">R$ 38,00</p>
<div class="o-product-description">
    <h2 class="a-description-title">Nutrição e Hidratação para Peles Secas</h2>
    <ul class="m-benefits-list">
        <li>Aveia: Agente esfoliante suave, remove células mortas sem irritar.</li>
        <li>Mel: Rico em enzimas e açúcares, possui ação umectante e nutritiva.</li>
        <li>Hidrata profundamente, sendo ideal para peles ressecadas e no inverno.</li>
        <li>Promove maciez e forma uma barreira protetora contra o ressecamento.</li>
    </ul>
    <p class="a-product-summary">Com uma textura cremosa e um aroma doce e delicado, o sabonete de Aveia e Mel é um carinho para a pele. Sua fórmula combina a esfoliação suave da aveia com a intensa nutrição do mel, garantindo uma pele incrivelmente macia e hidratada após o banho.</p>
</div>
