...
<head>
    ...
    <title>Sabonete Argila Rosa e Lavanda - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/sbnt-argilarosalavanda.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Sabonete Argila Rosa e lavanda</h1>
            <p class="a-product-price">R$ 36,00</p>
<div class="o-product-description">
    <h2 class="a-description-title">Suavidade e Calma para Peles Delicadas</h2>
    <ul class="m-benefits-list">
        <li>Argila Rosa: Promove limpeza suave e absorção da oleosidade sem ressecar a pele.</li>
        <li>Óleo Essencial de Lavanda: Oferece propriedades calmantes e relaxantes, ideais para o banho noturno.</li>
        <li>Restaura o viço natural da pele e uniformiza o tom.</li>
        <li>Ajuda a acalmar peles sensíveis, irritadas ou com rosácea.</li>
    </ul>
    <p class="a-product-summary">O sabonete de Argila Rosa e Lavanda combina a delicadeza da argila para uma limpeza nutritiva com o poder relaxante da Lavanda. É o cuidado ideal para equilibrar peles sensíveis, proporcionando um toque sedoso e um aroma que convida ao descanso.</p>
</div>
