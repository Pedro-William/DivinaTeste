...
<head>
    ...
    <title>Coco e Baunilha - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/sbnt-cocobaunilha.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Sabonete Coco e Baunilha</h1>
            <p class="a-product-price">R$ 38,00</p>
<div class="o-product-description">
    <h2 class="a-description-title">Doçura e Hidratação Tropical</h2>
    <ul class="m-benefits-list">
        <li>Óleo de Coco: Oferece hidratação intensa e cria uma barreira protetora na pele.</li>
        <li>Baunilha: Proporciona um aroma doce, reconfortante e relaxante.</li>
        <li>Alto poder nutritivo e umectante, combatendo o ressecamento.</li>
        <li>Deixa a pele aveludada e com uma fragrância suave e duradoura.</li>
    </ul>
    <p class="a-product-summary">O sabonete de Coco e Baunilha é uma indulgência para o banho. Sua espuma rica hidrata e nutre profundamente graças ao óleo de coco, enquanto o aroma da baunilha acalma a mente, transformando o seu cuidado diário em um ritual de bem-estar.</p>
</div>
