...
<head>
    ...
    <title>SaboneteLaranja e camomila - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/sbnt-laranjacamomila.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Sabonete Laranja e Camomila</h1>
            <p class="a-product-price">R$ 38,00</p>
<div class="o-product-description">
    <h2 class="a-description-title">Vitalidade e Equilíbrio para o Dia a Dia</h2>
    <ul class="m-benefits-list">
        <li>Laranja Doce: Proporciona um aroma cítrico e alegre, elevando o humor e o ânimo.</li>
        <li>Camomila: Suaviza a pele, minimizando irritações e sensibilidades.</li>
        <li>Traz o equilíbrio perfeito entre o estímulo revigorante e a suavidade calmante.</li>
        <li>Ajuda a clarear a mente e aliviar a tensão diária.</li>
    </ul>
    <p class="a-product-summary">O sabonete de Laranja e Camomila é o início perfeito para o seu dia ou o alívio ideal após a jornada. Ele combina o toque alegre da Laranja para dar energia com a tranquilidade da Camomila, resultando em uma pele limpa, macia e uma mente em harmonia.</p>
</div>
