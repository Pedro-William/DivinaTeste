...
<head>
    ...
    <title>Sabonete Camomila - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/sbnt-camomila.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Sabonete Camomila</h1>
            <p class="a-product-price">R$ 30,00</p>
<div class="o-product-description">
    <h2 class="a-description-title">Ação Calmante e Alívio para Irritações</h2>
    <ul class="m-benefits-list">
        <li>Extrato de Camomila: Possui propriedades suavizantes e anti-inflamatórias.</li>
        <li>Ideal para acalmar a pele após exposição solar ou depilação.</li>
        <li>Promove uma limpeza suave e delicada, adequada para peles sensíveis.</li>
        <li>Seu aroma leve e floral contribui para o relaxamento.</li>
    </ul>
    <p class="a-product-summary">O sabonete de Camomila é o refúgio de paz para sua pele. Sua fórmula suave minimiza vermelhidões e irritações, sendo o sabonete perfeito para quem busca um banho relaxante e um cuidado extra para a pele delicada.</p>
</div>
