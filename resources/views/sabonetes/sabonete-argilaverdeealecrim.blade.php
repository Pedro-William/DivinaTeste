...
<head>
    ...
    <title>Sabonete Argila Verde e Alecrim - Divina Essência</title>
    ...
    <header class="o-header">
        <div class="o-header__top">
            ...
            <div class="m-user-options">
                ...
                <a href="{{ asset('../meusfavoritos.html" class="a-icon-link">
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/sbnt-argilaverdealecrim.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Sabonete Argila Verde e Alecrim</h1>
            <p class="a-product-price">R$ 38,00</p>
<div class="o-product-description">
    <h2 class="a-description-title">Controle de Oleosidade e Limpeza Profunda</h2>
    <ul class="m-benefits-list">
        <li>Argila Verde: Alta capacidade de absorção, desintoxica e controla a oleosidade da pele.</li>
        <li>Óleo Essencial de Alecrim: Estimula a circulação, sendo um excelente tônico para a pele e o couro cabeludo.</li>
        <li>Ação adstringente, ajudando a fechar os poros e prevenir a acne.</li>
        <li>Proporciona uma sensação revigorante e de frescor imediato.</li>
    </ul>
    <p class="a-product-summary">Perfeito para peles oleosas e acneicas, este sabonete une a força purificadora da Argila Verde com a energia estimulante do Alecrim. Limpa profundamente sem agredir, deixando a pele com um aspecto matte e revigorado.</p>
</div>
  ...
  <h2 class="a-section-title">NOVIDADES</h2>
    ...
    <div class="m-product-card">
        ...
        <a href="/sabonetes/argila-rosa-lavanda" class="a-btn-add">Adicionar</a>
    </div>
    <div class="m-product-card">
        ...
        <a href="/acessorios/bucha-vegetal" class="a-btn-add">Adicionar</a>
    </div>
    <div class="m-product-card">
        ...
        <a href="/aromatizantes/citronela" class="a-btn-add">Adicionar</a>
    </div>
    <div class="m-product-card">
        ...
        <a href="/velas/blue-tansy" class="a-btn-add">Adicionar</a>
    </div>
    <div class="m-product-card">
        ...
        <p class="a-product-size">110g</p>
        <h3 class="a-product-price">R$ 38,00</h3>
        <a href="/sabonetes/aveia-e-mel" class="a-btn-add">Adicionar</a>
    </div>
    <div class="m-product-card">
        ...
        <a href="/acessorios/ecobag" class="a-btn-add">Adicionar</a>
    </div>
    <div class="m-product-card">
        <img src="../img/aroma-citronela.png" alt="Aromatizador Citronela" class="a-product-img">
        <h4 class="a-product-name">Citronela </h4>
        ...
        <div class="m-cart-items-list">
            ...
            <div class="m-cart-item" style="display: none;">
                <div class="a-item-image">
                    <img src="{{ asset('../img/bucha-vegetal-cart.png" alt="Bucha Vegetal">
                </div>
