...
<head>
    ...
    <title>Sabonete Canela - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/sbnt-canelaand White Floral Save The Date Flyer.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Sabonete Canela</h1>
            <p class="a-product-price">R$ 30,00</p>
<div class="o-product-description">
    <h2 class="a-description-title">Estimulante e Aromatizante Natural</h2>
    <ul class="m-benefits-list">
        <li>Óleo Essencial de Canela: Proporciona um aroma quente, estimulante e acolhedor.</li>
        <li>Ajuda a ativar a circulação superficial da pele.</li>
        <li>Ação antisséptica natural e purificante.</li>
        <li>Ideal para banhos energizantes, revigorando o corpo e a mente.</li>
    </ul>
    <p class="a-product-summary">Com um aroma picante e envolvente, o sabonete de Canela transforma o seu banho em uma experiência sensorial e energizante. É uma excelente escolha para estimular a vitalidade e aquecer os sentidos, deixando um perfume marcante na pele.</p>
</div>
