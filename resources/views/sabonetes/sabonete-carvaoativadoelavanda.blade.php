...
<head>
    ...
    <title>Sabonete Carvão Ativo e Lavanda- Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/sbnt-carvao.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Sabonete Carvão Ativado e Lavanda</h1>
            <p class="a-product-price">R$ 38,00</p>
<div class="o-product-description">
    <h2 class="a-description-title">Detox Profundo e Relaxamento</h2>
    <ul class="m-benefits-list">
        <li>Carvão Ativado: Absorve toxinas, impurezas e o excesso de oleosidade da pele.</li>
        <li>Óleo Essencial de Lavanda: Balanceia o efeito purificante com uma ação calmante.</li>
        <li>Promove um efeito detox, ideal para peles expostas à poluição.</li>
        <li>Limpa os poros profundamente, minimizando o surgimento de cravos e espinhas.</li>
    </ul>
    <p class="a-product-summary">Este sabonete de alto poder purificante combina a limpeza profunda do Carvão Ativado com o efeito suave da Lavanda. É o tratamento ideal para desintoxicar a pele do rosto e corpo, garantindo a sensação de frescor e pureza, sem ressecar.</p>
</div>
