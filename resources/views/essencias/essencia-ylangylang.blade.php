...
<head>
    ...
    <title>Óleo Essencial  Ylang Ylang - Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/essencia-ylangglang.png" alt="Óleo Essencial de Ylang Ylang embalagem Divina Essência"
                    class="a-main-product-image">
            </div> 

            <div class="m-product-info">
                <h1 class="a-product-title">Óleo Essencial de Ylang Ylang</h1>
                <p class="a-product-price">R$ 53,90</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Alívio da Tensão: Atua como um poderoso calmante do sistema nervoso, auxiliando a reduzir a ansiedade, o medo e a irritabilidade, promovendo a paz interior.</li>
                        <li>Afrodisíaco Natural: Seu aroma floral exótico e doce é conhecido por despertar a sensualidade, ajudando a liberar inibições e a promover a conexão íntima e o prazer.

                        </li>
                        <li>Equilíbrio Emocional: Ajuda a regular o humor e a promover um estado de alegria e autoconfiança, sendo um excelente aliado para a autoestima.                   </li>
                        <li>Óleo essencial puro e concentrado, 
                            não deve ser aplicado diretamente na pele.</li>
                    ...
                    <p class="a-product-summary">Use o Óleo Essencial de Ylang Ylang no difusor para criar um ambiente luxuoso e sedutor. Dilua em óleos vegetais para massagens relaxantes ou para perfumar o corpo. É o óleo da alegria e do amor-próprio, que transforma o ambiente e eleva o seu humor.
