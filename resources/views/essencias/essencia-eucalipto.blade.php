...
<head>
    ...
    <title>Óleo Essencial Eucalipto - Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/essencia-eucalipto.png" alt="Óleo Essencial de Eucalipto com embalagem Divina Essência"
                    class="a-main-product-image">
            </div> 

            <div class="m-product-info">
                <h1 class="a-product-title">Óleo Essencial de Eucalipto </h1>
                <p class="a-product-price">R$ 55,00</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Respiro Profundo: Reconhecido por suas propriedades expectorantes e descongestionantes, é o óleo essencial mais eficaz para auxiliar a respiração em momentos de tosse ou vias aéreas obstruídas.

                            .</li>
                        <li>Purificação Ambiental: Seu aroma canforado e potente limpa e purifica o ar, eliminando odores e criando um ambiente com sensação de frescor medicinal.

                        </li>
                        <li>Foco e Revitalização: O frescor intenso ajuda a clarear a mente e a combater a sonolência e a letargia, promovendo um senso de vitalidade e vigor.
                    ...
                    <p class="a-product-summary">Use o Óleo Essencial de Eucalipto em inalações ou no difusor para auxiliar a saúde respiratória e purificar o ambiente. Dilua em água quente para vapores ou em um óleo carreador para massagens no peito e costas. É o aliado perfeito para criar um spa de frescor em casa.
