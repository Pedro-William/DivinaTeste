...
<head>
    ...
    <title>Óleo Essencial Copaiba - Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/essencia-copaiba.png" alt="Óleo Essencial de Copaiba com embalagem Divina Essência"
                    class="a-main-product-image">
            </div> 

            <div class="m-product-info">
                <h1 class="a-product-title">Óleo Essencial de Copaiba</h1>
                <p class="a-product-price">R$ 54,80</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Regeneração da Pele: Conhecido como o "Antibiótico da Amazônia", auxilia na saúde e cicatrização da pele, sendo excelente para peles irritadas,
                             acneicas ou com sensibilidade.</li>
                        <li>Ação Anti-Inflamatória: É um poderoso anti-inflamatório natural, ideal para ser diluído em massagens para aliviar dores musculares,
                             articulares e desconfortos. </li>
                        <li>Aterramento Emocional: Seu aroma amadeirado e balsâmico promove o aterramento e o centramento, 
                            ajudando a acalmar a mente e as emoções em momentos de estresse.                            .</li>
                        <li>Óleo essencial puro e concentrado, não deve ser aplicado diretamente na pele.                    </li>

                    </ul>

                    <p class="a-product-summary">Use o Óleo Essencial de Copaíba diluído em um óleo vegetal para cuidar da pele e fazer massagens terapêuticas nas áreas de dor. No difusor, ele traz uma sensação de paz profunda e conexão com a natureza, sendo o aliado ideal para o seu bem-estar físico e emocional.
