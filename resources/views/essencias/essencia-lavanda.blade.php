...
<head>
    ...
    <title>Óleo Essencial Lavanda - Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/essencia-lavanda.png" alt="Óleo Essencial de Lavanda com embalagem Divina Essência"
            ...
            <div class="m-product-info">
                <h1 class="a-product-title">Óleo Essencial de Lavanda</h1>
                ...
                <div class="o-product-description">
                    ...
                    <ul class="m-benefits-list">
                        <li>Relaxamento Universal: É o óleo essencial mais conhecido para acalmar o sistema nervoso,
                            dissolvendo rapidamente o estresse, a ansiedade e a agitação mental.

                        </li>
                        <li>Sono Reparador: Favorece a transição para um sono profundo e de qualidade, sendo
                            indispensável para quem sofre com insônia ou tem dificuldade em desligar a mente à noite.

                        </li>
                        <li>Regeneração e Cuidado da Pele: Diluído em um óleo carreador, auxilia na cicatrização e no
                            alívio de queimaduras, picadas e irritações, graças às suas propriedades suaves.</li>
                        <li>Óleo essencial puro e concentrado, não deve ser aplicado diretamente na pele.
                    ...
                    <p class="a-product-summary">Use o Óleo Essencial de Lavanda no difusor para transformar qualquer
                        ambiente em um santuário de calma. Aplique uma gota diluída nos pulsos ou na sola dos pés antes
                        de dormir. É o "coringa" da aromaterapia, proporcionando conforto imediato e bem-estar para toda
                        a família.
