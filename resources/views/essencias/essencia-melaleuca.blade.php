...
<head>
    ...
    <title>Óleo Essencial Melaleuca - Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/essencia-melaleuca.png" alt="Óleo Essencial de Melaleuca com embalagem Divina Essência"
                    class="a-main-product-image">
            </div>
            <div class="m-product-info">
                <h1 class="a-product-title">Óleo Essencial de Melaleuca </h1>
                ...
                <div class="o-product-description">
                    ...
                    <ul class="m-benefits-list">
                        <li>Poder Purificador: É amplamente reconhecido por suas propriedades que ajudam a combater
                            agentes externos indesejados, sendo um item essencial para a higiene pessoal e do ambiente.

                        </li>
                        <li>Saúde da Pele e Unhas: Diluído em óleos vegetais, é excelente para cuidar de peles acneicas,
                            oleosas e para fortalecer e tratar as unhas e a cutícula.

                        </li>
                        <li>Limpeza e Proteção: Seu aroma herbal e canforado purifica o ar,
                            promovendo uma sensação de higiene e frescor no ambiente.</li>
                    ...
                    <p class="a-product-summary">Use o Óleo Essencial de Melaleuca diluído em seu skincare para peles
                        oleosas, ou em óleos vegetais para cuidado das unhas e pés. No difusor, ele proporciona um
                        ambiente limpo e protegido. É o protetor natural que não pode faltar no seu armário de primeiros
                        socorros.
