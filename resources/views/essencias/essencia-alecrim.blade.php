...
<head>
    ...
    <title>Óleo Essencial Alecrim - Divina Essência</title>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/essencia-alecrim.png" alt="Óleo Essencial de Alecrim com embalagem Divina Essência"
                    class="a-main-product-image">
            </div> 

            <div class="m-product-info">
                <h1 class="a-product-title">Óleo Essencial Alecrim</h1>
                <p class="a-product-price">R$ 50,00</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Tônico Mental e Foco: Conhecido como o óleo da concentração, estimula a memória e a clareza
                            mental, sendo essencial para estudos e trabalho..</li>
                        <li>Alívio Muscular e Circulatório: Ideal para ser diluído em óleos vegetais e usado em
                            massagens, auxiliando na melhora da circulação e no alívio de tensões musculares..</li>
                        <li>Energia Revigorante: Seu aroma herbal e canforado proporciona um impulso de vitalidade,
                            ajudando a combater a fadiga física e o desânimo.</li>
                    ...
                    <p class="a-product-summary">Use o Óleo Essencial de Alecrim no difusor pela manhã para energizar o
                        ambiente de estudo ou trabalho. Dilua em um óleo carreador para massagens revigorantes ou use em
                        inalações para um alívio respiratório. É o tônico natural para o corpo e a mente.
