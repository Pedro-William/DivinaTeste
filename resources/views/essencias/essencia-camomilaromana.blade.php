...
<head>
    ...
    <title>Óleo Essencial Camomila Romana -  Divina Essência</title>
...
<body>
    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/essencia-camomilaromana.png" alt="Óleo Essencial de Camomila Romana com embalagem Divina Essência"
                    class="a-main-product-image">
            </div> 

            <div class="m-product-info">
                <h1 class="a-product-title">Óleo Essencial de Camomila Romana</h1>
                <p class="a-product-price">R$ 56,00</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Calmante Profundo: Reconhecido por suas propriedades que promovem uma serenidade imediata, sendo o óleo essencial ideal para aliviar o choque, a raiva e o estresse agudo.</li>
                        <li>Paz para a Mente e o Sono: Essencial para pacificar a agitação mental e emoções intensas, favorecendo um estado de relaxamento que facilita um sono tranquilo e reparador.                  </li>
                        <li>Suavizante para a Pele: Diluído em um óleo vegetal, pode ser usado para acalmar peles irritadas, sensíveis ou com vermelhidão, graças às suas propriedades delicadas.                        </li>
                        <li>Óleo essencial puro e concentrado, não deve ser aplicado diretamente na pele.                        </li>
                    ...
                    <p class="a-product-summary">Use o Óleo Essencial de Camomila Romana no difusor à noite ou em momentos de grande tensão para criar um refúgio de paz. Dilua para massagens suaves em regiões de pulso ou plexo solar. É o "óleo do colo", trazendo conforto emocional e tranquilidade profunda.
    ...
    <section class="o-product-grid" id="novidades">
        <h2 class="a-section-title">Produtos relacionados</h2>
    ...
    <div class="m-product-card">
        ...
        <a href="/home/acessorios/bucha-vegetal" class="a-btn-add">Adicionar</a>
    </div>
    ...
    <div class="m-product-card">
        ...
        <p class="a-product-size">...</p>
        <h3 class="a-product-price">R$ 19,20</h3>
        <a href="/home/acessorios/bucha-vegetal-2" class="a-btn-add">Adicionar</a>
    </div>

    <div class="m-product-card">
        <img src="../img/aroma-canela.png" alt="Aromatizador Canela" class="a-product-img">
            ...
            <div class="m-cart-items-list">
                ...
                <div class="m-cart-item" style="display: none;">
                    <div class="a-item-image">
                        <img src="../img/bucha-vegetal-cart.png" alt="Bucha Vegetal"> <!--MUDAR-->

                    </div>
                    <div class="a-item-details">
                        <p class="a-item-name">Bucha vegetal</p> <!--MUDAR-->
