    ...
    <main class="container-principal">
        <section class="o-product-detail">
            ...
            <div class="m-product-gallery">
                <img src="../img/essencia-citronela.png" alt="Óleo Essencial de Cintronela com embalagem Divina Essência"
                    class="a-main-product-image">
            </div> 

            <div class="m-product-info">
                <h1 class="a-product-title">Óleo Essencial de Cintronela </h1>
                <p class="a-product-price">R$ 52,90</p>

                <div class="o-product-description">
                    <h2 class="a-description-title">Benefícios</h2>
                    <ul class="m-benefits-list">
                        <li>Repelência Natural: O aroma cítrico e intenso da Citronela é o mais conhecido para afastar
                            insetos, sendo um aliado essencial para o conforto em casa e ao ar livre.

                        </li>
                        <li>Purificação do Ar: Ajuda a neutralizar odores fortes e a purificar o ambiente, deixando o ar
                            com uma sensação de limpeza, frescor e vigor. </li>
                        <li>Tônico Refrescante: Seu perfume vibrante revigora a mente e o corpo, promovendo ânimo e
                            clareza, especialmente em momentos de letargia. </li>
                    ...
                    <p class="a-product-summary">Use o Óleo Essencial de Citronela no difusor para proteger e refrescar
                        a casa, varanda ou áreas externas. É ideal para limpeza funcional de pisos e superfícies,
                        diluído em água, garantindo um ambiente naturalmente purificado e livre de insetos.
