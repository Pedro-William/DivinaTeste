...
<head>
    ...
    <title>Pedidos - Divina Essência</title>
    <link rel="stylesheet" href="{{ asset('css/app.css')}}"> 
    <link rel="stylesheet" href="{{ asset('css/atomic/atoms/form_elements.css')}}">
    <link rel="stylesheet" href="{{ asset('css/atomic/molecules/inputform.css')}}">
    <link rel="stylesheet" href="{{ asset('css/atomic/organisms/bloco.css')}}"> 
...
<body>
 ...
 <div class="container-principal">
        ...
        <h1 class="titulo-cadastro">MEUS PEDIDO</h1>
        ...
        <div class="form-container dados-conta-container">
            ...
            <div class="bloco-dados">
                ...
                <p>Endereços: xxxxxxxxxxxxxx</p>
                <p>CEP: xxxxx-xx</p>

            </div>
            
            <button type="button" class="btn-cadastro btn-editar">
                <i class="fas fa-pencil-alt"></i> Confirmar Entrega
            </button>
