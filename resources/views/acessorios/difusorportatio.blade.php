...
<head>
    ...
    <title>Difusor Portátio - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/acessorio-difusorportatio.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Difusor Portátil</h1>
            <p class="a-product-price">R$ 43,00</p>
            
            <div class="o-product-description">
                <h2 class="a-description-title">Benefícios</h2>
                <ul class="m-benefits-list">
                    <li>Uso Simples e Prático</li>
                    <li>Aromatização Contínua</li>
                    <li>Segurança e Economia</li>
                    <li>Design Elegante</li>
                </ul>
                <p class="a-product-summary">Para higienizar, retire o aparelho da tomada e utilize um pano seco ou papel toalha. Não lavar em água corrente.</p>
            </div>
            <div class="m-buy-options">
                ...
                <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="7">
                    Comprar
                </button>  
            </div>
        </div>
  ...
  <h2 class="a-section-title">NOVIDADES</h2>
    ...
    <div class="m-product-card">
        ...
        <p class="a-product-size">110g</p>
        <h3 class="a-product-price">R$ 38,00</h3>
        <!-- CORRIGIDO: Rota Sabonete Aveia e Mel (fora do prefixo de sub-itens) -->
