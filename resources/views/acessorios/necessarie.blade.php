...
<head>
    ...
    <title>Necessarie - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/acessorio-necessarie.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Necessarie</h1>
            <p class="a-product-price">R$ 44,70</p>
        ...
        <div class="o-product-description">
            ...
            <div class="m-buy-options">
                ...
                <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="11">
                    Comprar
                </button>  
            </div>
        </div>
