...
<head>
    ...
    <title>Difusor - Divina Essência</title>
    ...
    <link rel="stylesheet" href="{{ asset('/css/atomic/molecules/productpage.css')}}"> 
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/acessorio-difusor.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Difusor</h1>
            <p class="a-product-price">R$ 30,50</p>
            ...
            <div class="m-buy-options">
                ...
                <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="6">
                    Comprar
                </button>  
            </div>
        </div>
