...
<head>
    ...
    <title>Escova de Cabelo - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/acessorio-escovadecabelo.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Escova de cabelo</h1>
            <p class="a-product-price">R$ 22,00</p>
            
            <div class="o-product-description">
            <h2 class="a-description-title">Beleza e Sustentabilidade para seus Fios</h2>
            <ul class="m-benefits-list">
                <li>Corpo e pinos feitos de Bambu: Material leve, durável e renovável.</li>
                <li>Massageia o couro cabeludo: Estimula a circulação e o crescimento saudável dos fios.</li>
                <li>Anti-estática: Reduz o frizz e o rompimento dos cabelos durante o uso.</li>
                <li>Desembaraça sem agredir: Ideal para todos os tipos de cabelo, secos ou úmidos.</li>
            </ul>
            <p class="a-product-summary">Passe para um ritual de beleza mais consciente. Nossa Escova de Cabelo de Bambu é a ferramenta perfeita para desembaraçar e alinhar seus cabelos de forma suave, contribuindo para a saúde do seu couro cabeludo e para a redução do plástico no planeta.</p>
        </div>
            <div class="m-buy-options">
                ...
                <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="8">
                    Comprar
                </button>  
            </div>
        </div>
