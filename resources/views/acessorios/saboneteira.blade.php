...
<head>
    ...
    <title>Saboneteira - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/acessorio-saboneteira.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Saboneteira</h1>
            <p class="a-product-price">R$ 30,00</p>
            
        <div class="o-product-description">
        <h2 class="a-description-title">Durabilidade e Cuidado para seu Sabonete</h2>
        <ul class="m-benefits-list">
            <li>Design otimizado: Permite a drenagem completa da água, evitando o acúmulo.</li>
            <li>Prolonga a vida útil do sabonete: Mantém o sabonete seco e firme por mais tempo.</li>
            <li>Acabamento sofisticado: Peça ideal para o seu banheiro ou lavabo.</li>
            <li>Material de qualidade: Fácil de limpar e resistente à umidade.</li>
        </ul>
        <p class="a-product-summary">A Saboneteira Divina Essência é um item essencial para quem usa sabonetes artesanais. Ao garantir a secagem adequada, ela preserva a integridade, o aroma e a durabilidade do seu sabonete, garantindo o melhor custo-benefício e um visual mais elegante.</p>
    </div>
            <div class="m-buy-options">
                ...
                <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="12">
                    Comprar
                </button>  
            </div>
        </div>
