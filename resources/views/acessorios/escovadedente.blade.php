...
<head>
    ...
    <title>Escova de dente - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/acessorio-escova.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Escova de dente</h1>
            <p class="a-product-price">R$ 19,70</p>
            
            <div class="o-product-description">
                <h2 class="a-description-title">O Cuidado Diário Mais Natural</h2>
                <ul class="m-benefits-list">
                    <li>Haste 100% Bambu Moso: Recurso altamente renovável e biodegradável.</li>
                    <li>Cerdas de Carvão Ativado: Ajuda a remover manchas e manter o hálito fresco.</li>
                    <li>Livre de Plástico (exceto cerdas): Reduza sua pegada ecológica no banheiro.</li>
                    <li>Design Ergonômico: Cabo leve e confortável para uma escovação eficaz.</li>
                </ul>
                <p class="a-product-summary">Comece o seu dia com uma escolha sustentável. Nossa Escova de Dente de Bambu oferece uma limpeza eficaz enquanto minimiza seu impacto ambiental, sendo a troca mais simples e importante para um estilo de vida zero waste.</p>
            </div>
            ...
            <div class="m-buy-options">
                ...
                <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="9">
                    Comprar
                </button>  
            </div>
        </div>
