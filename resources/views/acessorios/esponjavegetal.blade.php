...
<head>
    ...
    <title>Bucha Vegetal - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/acessorio-buchavegetal.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Bucha Vegetal</h1>
            <p class="a-product-price">R$ 19,20</p>
            
            <div class="o-product-description">
                <h2 class="a-description-title">Benefícios</h2>
                <ul class="m-benefits-list">
                    <li>Esfoliação natural e delicada</li>
                    <li>Melhora da circulação</li>
                    <li>Pele mais macia e renovada</li>
                    <li>Produto 100% natural e ecológico</li>
                </ul>
                <p class="a-product-summary">Ideal para usar no banho ou em massagens relaxantes, trazendo um toque de natureza para o seu ritual de bem-estar.</p>
            </div>
            <div class="m-buy-options">
                ...
                <button class="a-btn-buy" id="btn-add-to-cart" data-product-id="10">
                    Comprar
                </button>  
            </div>
        </div>
  ...
  <h2 class="a-section-title">NOVIDADES</h2>
    ...
    <div class="m-product-card">
        ...
        <!-- CORRIGIDO: Rota blue tansy (Preço ajustado para R$ 30,00 conforme o código mais recente que você forneceu) -->
