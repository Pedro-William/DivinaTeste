...
<head>
    ...
    <title>Kit Capim Limão - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/kits-capimlimao.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Kit Capim Limão</h1>
            <p class="a-product-price">R$ 89,90</p>
            
     
<div class="o-product-description">
    <h2 class="a-description-title">Foco, Clareza Mental e Refrescância</h2>
    <ul class="m-benefits-list">
        <li>Potente tônico mental, melhorando a concentração e aliviando a fadiga mental.</li>
        <li>Propriedades antissépticas e desodorizantes, excelente como repelente natural.</li>
        <li>Ajuda a aliviar dores de cabeça tensionais e dores musculares (em compressas ou massagens).</li>
        <li>Seu aroma cítrico e fresco proporciona uma sensação de limpeza e ânimo.</li>
    </ul>
    <p class="a-product-summary">O Capim Limão é o óleo da organização e do foco. Utilize-o para clarear a mente, afastar pensamentos dispersos e trazer uma energia de renovação e frescor para o seu dia a dia e para o seu ambiente.</p>
</div>
