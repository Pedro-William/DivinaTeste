...
<head>
    ...
    <title>Kit Blue Tansy - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/kits-bluetansy.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Kit Blue Tansy</h1>
            <p class="a-product-price">R$ 149,90</p>
            
            <div class="o-product-description">
    <h2 class="a-description-title">Poder Calmante e Regenerador</h2>
    <ul class="m-benefits-list">
        <li>Propriedades anti-inflamatórias potentes, ideal para acalmar peles irritadas ou sensíveis.</li>
        <li>Ajuda a reduzir a vermelhidão e reações alérgicas.</li>
        <li>Seu aroma doce e herbal promove o relaxamento e alívio de tensões emocionais.</li>
        <li>Cor azul intensa devido ao Camazuleno, um poderoso agente calmante.</li>
    </ul>
    <p class="a-product-summary">O Blue Tansy é um óleo valioso para o skincare e aromaterapia. É procurado por sua capacidade de acalmar a pele inflamada, sendo um excelente aliado em séruns e cremes noturnos para uma recuperação profunda.</p>
</div>
