...
<head>
    ...
    <title>Kit Copaiba - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/kits-copaiba.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Kit Copaiba</h1>
            <p class="a-product-price">R$ 185,00</p>
            
            <div class="o-product-description">
    <h2 class="a-description-title">O Poder Anti-inflamatório da Amazônia para a sua Rotina</h2>
    <ul class="m-benefits-list">
        <li>Ação anti-inflamatória e antisséptica natural, ideal para peles sensíveis ou com acne.</li>
        <li>Controla a oleosidade do couro cabeludo, ajudando a combater caspa e seborreia.</li>
        <li>Promove a cicatrização e regeneração da pele em casos de dermatites e irritações.</li>
        <li>Fortalece os fios, dando brilho e maciez sem pesar.</li>
        <li>Kit completo para um tratamento corporal, profundo e natural.</li>
    </ul>
    <p class="a-product-summary">O Kit Copaíba Divina Essência traz a força da resina extraída da Copaifera Officinalis para cuidar da sua pele e cabelo de forma completa. Conhecido por suas propriedades curativas e regeneradoras, o óleo de Copaíba é o tratamento ideal para equilibrar a oleosidade, acalmar irritações e restaurar o brilho e a saúde dos seus fios. Invista em um cuidado vindo da biodiversidade brasileira.</p>
</div>
