...
<head>
    ...
    <title>Kit Ylang Lang - Divina Essência</title>
    ...
    <link rel="stylesheet" href="{{ asset('s../css/atomic/organisms/productpage.css')}}"> 
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/kits-yanglang.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Kit Yang Lang</h1>
            <p class="a-product-price">R$ 65,00</p>
            
<div class="o-product-description">
    <h2 class="a-description-title">Aroma Floral Exótico e Sedutor</h2>
    <ul class="m-benefits-list">
        <li>Ótimo regulador emocional, combatendo o estresse, a raiva e a frustração.</li>
        <li>Conhecido por suas propriedades afrodisíacas e de resgate da sensualidade e autoconfiança.</li>
        <li>Atua como tônico capilar, ajudando a equilibrar a oleosidade do couro cabeludo.</li>
        <li>Ajuda a controlar a pressão arterial em momentos de grande tensão.</li>
    </ul>
    <p class="a-product-summary">O Ylang Ylang é a essência do luxo e do relaxamento profundo. Seu perfume floral e exótico cria uma atmosfera de paz e bem-estar, ideal para massagens e para despertar a autoestima e a conexão pessoal.</p>
</div>
