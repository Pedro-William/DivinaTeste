...
<head>
    ...
    <title>Kit Canela - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/kits-canela.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Kit Canela</h1>
            <p class="a-product-price">R$ 110,50</p>
            
     
<div class="o-product-description">
    <h2 class="a-description-title">Aroma Quente e Estimulante</h2>
    <ul class="m-benefits-list">
        <li>Propriedades estimulantes, ideal para revigorar o corpo e a mente.</li>
        <li>Ação antisséptica e purificadora de ambientes.</li>
        <li>Na pele (sempre diluído), tem efeito rubefaciente, auxiliando em massagens para o aquecimento muscular.</li>
        <li>Seu aroma doce e picante é acolhedor e ajuda a combater o desânimo.</li>
    </ul>
    <p class="a-product-summary">O óleo de Canela traz a sensação de calor e aconchego. É amplamente utilizado na aromaterapia para estimular a circulação, aumentar a energia e criar uma atmosfera acolhedora e festiva, especialmente em momentos de fadiga.</p>
</div>
