...
<head>
    ...
    <title>Kit Lavanda - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/kits-lavanda.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Kit Lavanda</h1>
            <p class="a-product-price">R$ 75,00</p>
            
     
<div class="o-product-description">
    <h2 class="a-description-title">O Mais Versátil e Relaxante</h2>
    <ul class="m-benefits-list">
        <li>Reconhecido por suas propriedades calmantes, alivia o estresse, a insônia e a ansiedade.</li>
        <li>Excelente cicatrizante e regenerador de pele, sendo usado em queimaduras leves e irritações.</li>
        <li>Ação analgésica suave, auxiliando no alívio de dores de cabeça e cólicas.</li>
        <li>Promove o equilíbrio emocional e a harmonia.</li>
    </ul>
    <p class="a-product-summary">A Lavanda é considerada o "canivete suíço" dos óleos essenciais. É indispensável na aromaterapia e nos cuidados diários, oferecendo alívio imediato para o sistema nervoso e atuando como um poderoso restaurador da pele.</p>
</div>
