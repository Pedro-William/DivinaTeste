...
<head>
    ...
    <title>Kit Camomila - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="../img/kits-camomila.png" alt="Bucha Vegetal com embalagem Divina Essência" class="a-main-product-image">
        </div>

        <div class="m-product-info">
            <h1 class="a-product-title">Kit Camomila</h1>
            <p class="a-product-price">R$ 95,00</p>
            
     <div class="o-product-description">
    <h2 class="a-description-title">Suavidade e Conforto para a Pele</h2>
    <ul class="m-benefits-list">
        <li>Excelente calmante para a pele, eficaz no tratamento de eczemas, dermatites e pele seca.</li>
        <li>Alivia o estresse e a ansiedade, promovendo um sono reparador.</li>
        <li>Ação anti-inflamatória suave, ideal para peles de bebês e crianças.</li>
        <li>Usado em tratamentos capilares para dar brilho e realçar tons claros.</li>
    </ul>
    <p class="a-product-summary">A Camomila é um clássico do bem-estar, sinônimo de gentileza e alívio. Seja na pele ou no difusor, este óleo proporciona conforto imediato, reduzindo a hiperatividade e a irritação física ou emocional.</p>
</div>
