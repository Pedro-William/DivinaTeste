...
<head>
    ...
    <title>Vela Bluetansy - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-info">
            <h1 class="a-product-title">Vela de Bluetansy </h1>
            <p class="a-product-price">R$ 23,40</p>
            
            <div class="o-product-description">
                
                <h2 class="a-description-title">Benefícios</h2>
                <ul class="m-benefits-list">
                    <li><strong>Calmaria Profunda:</strong> O óleo essencial de Bluetansy é conhecido por suas propriedades relaxantes, ajudando a aliviar tensões emocionais e promover serenidade.</li>
        <li><strong>Aroma Floral e Exótico:</strong> Com notas suaves e levemente adocicadas, cria uma atmosfera delicada e sofisticada, ideal para momentos de autocuidado.</li>
        <li><strong>Equilíbrio Energético:</strong> Auxilia na harmonização do ambiente, favorecendo práticas meditativas e estados de introspecção.</li>
        <li><strong>Feita com delicadeza:</strong> Produção artesanal com óleos essenciais puros, respeitando a essência terapêutica da Bluetansy.</li>
    </ul>

    <p class="a-product-summary">
        Acenda a Vela de Bluetansy ao final do dia, durante um ritual de relaxamento ou em momentos que pedem acolhimento emocional. Seu perfume floral e envolvente transforma qualquer espaço em um santuário de paz e equilíbrio.
    </p>
</div>            <!--MUDAR-->
  ...
  <h2 class="a-section-title">Produtos relacionados</h2>
    ...
    <div class="m-carousel-view" id="carousel-novidades">
        ...
        <div class="m-product-row">
            <div class="m-product-card"> 
                <img src="{{ asset('../img/sbnt-argilarosalavanda.png" alt="Sabonete Argila Rosa e Lavanda" class="a-product-img"> 
                ...
                <a href="{{ asset('../sabonetes/sabonete-argilarosaelavanda.html" class="a-btn-add">Adicionar</a>
    ...
    <div class="m-product-card">
        ...
        <a href="/home/sabonetes/argila-rosa-lavanda" class="a-btn-add">Adicionar</a>
    </div>
    <div class="m-product-card">
    ...
    <div class="m-product-card">
        ...
        <p class="a-product-size">110g</p>
        <h3 class="a-product-price">R$ 38,00</h3>
        <a href="/home/sabonetes/aveia-e-mel" class="a-btn-add">Adicionar</a>
    </div>
    <div class="m-product-card">
        ...
        <div class="m-cart-items-list">
            ...
            <div class="m-cart-item" style="display: none;">
                <div class="a-item-image">
                    <img src="{{ asset('../img/bucha-vegetal-cart.png" alt="Bucha Vegetal">   <!--MUDAR-->
                ...
                <div class="a-item-price-remove">
                    <p class="a-item-price">R$ 30,00</p>   <!--MUDAR-->
