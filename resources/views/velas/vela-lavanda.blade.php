...
<head>
    ...
    <title>Vela Lavanda - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/vela-lavanda.png" alt="Vela de Lavanda com embalagem Divina Essência" class="a-main-product-image">
        </div>            <!--MUDAR-->

            <!--MUDAR-->

        <div class="m-product-info">
            <h1 class="a-product-title">Vela de Lavanda </h1>
            <p class="a-product-price">R$ 22,00</p>
            
            <div class="o-product-description">
                <h2 class="a-description-title">Benefícios</h2>
                <ul class="m-benefits-list">
                    <li><strong>Tranquilidade Instantânea:</strong> A lavanda é reconhecida por seu efeito calmante, ideal para aliviar o estresse e promover relaxamento profundo.</li>
                    <li><strong>Sono Restaurador:</strong> Seu aroma suave prepara o corpo e a mente para uma noite tranquila, favorecendo o descanso e a qualidade do sono.</li>
                    <li><strong>Ambiente Acolhedor:</strong> Cria uma atmosfera serena e acolhedora, perfeita para momentos de autocuidado, meditação ou leitura.</li>
                    <li><strong>Feita com carinho:</strong> Produção artesanal com óleos essenciais puros, garantindo uma experiência sensorial delicada e terapêutica.</li>
                </ul>

                        <p class="a-product-summary">
                            Acenda a Vela de Lavanda ao final do dia, durante um banho relaxante ou antes de dormir. Seu perfume floral e reconfortante transforma qualquer espaço em um refúgio de paz e bem-estar.
                        </p>
            </div>
                            <!--MUDAR-->
