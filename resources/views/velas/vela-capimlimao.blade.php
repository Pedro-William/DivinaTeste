...
<head>
    ...
    <title>Vela Capim Limão - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/vela-capimlimao.png" alt="Vela de Capim Limão com embalagem Divina Essência" class="a-main-product-image">
        </div>            <!--MUDAR-->

            <!--MUDAR-->

        <div class="m-product-info">
            <h1 class="a-product-title">Vela de Capim Limão </h1>
            <p class="a-product-price">R$ 21,00</p>
            
            <div class="o-product-description">
                <h2 class="a-description-title">Benefícios</h2>
                <ul class="m-benefits-list">
                    <li><strong>Equilíbrio Emocional:</strong> O aroma cítrico do capim-limão ajuda a reduzir a tensão e a ansiedade, promovendo leveza e bem-estar.</li>
                    <li><strong>Estímulo Natural:</strong> Ideal para despertar a mente e renovar a energia, trazendo mais disposição para o dia.</li>
                    <li><strong>Ambiente Refrescante:</strong> Purifica o ar e deixa o espaço com uma fragrância suave e agradável, perfeita para dias quentes ou ambientes fechados.</li>
                    <li><strong>Feita com carinho:</strong> Produção artesanal com óleos essenciais puros, respeitando a essência vibrante do capim-limão.</li>
                </ul>
            
                <p class="a-product-summary">
                    Acenda a Vela de Capim-Limão ao iniciar a manhã, durante práticas de yoga ou em momentos que pedem leveza e clareza. Seu perfume cítrico e herbal transforma o ambiente em um espaço revigorante e harmonioso.
                </p>
            </div>          <!--MUDAR-->
