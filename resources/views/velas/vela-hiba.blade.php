...
<head>
    ...
    <title>Vela Hiba - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/vela-hiba.png" alt="Vela de Hiba com embalagem Divina Essência" class="a-main-product-image">
        </div>            <!--MUDAR-->

            <!--MUDAR-->

        <div class="m-product-info">
            <h1 class="a-product-title">Vela de Hiba </h1>
            ...
            <div class="o-product-description">
                ...
                <ul class="m-benefits-list">
                    <li><strong>Conexão com a Natureza:</strong> O aroma da madeira de Hiba evoca florestas japonesas, trazendo uma sensação de enraizamento e tranquilidade.</li>
        <li><strong>Purificação Sutil:</strong> Com propriedades naturalmente antimicrobianas, ajuda a renovar o ar e criar um ambiente mais limpo e equilibrado.</li>
        <li><strong>Atmosfera Aconchegante:</strong> Ideal para momentos de introspecção, leitura ou descanso, envolvendo o espaço com calor e serenidade.</li>
        <li><strong>Feita com cuidado:</strong> Produção artesanal com óleos essenciais puros, respeitando a essência natural da madeira de Hiba.</li>
    </ul>
    ...
    <p class="a-product-summary">
        Acenda a Vela de Hiba em dias nublados, durante uma pausa silenciosa ou ao final da tarde. Seu perfume amadeirado e suave transforma qualquer ambiente em um refúgio acolhedor e contemplativo.
    </p>          <!--MUDAR-->
