...
<head>
    ...
    <title>Vela Camomila - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/vela-camomila.png" alt="Vela Camomila com embalagem Divina Essência" class="a-main-product-image">
        </div>            <!--MUDAR-->

            <!--MUDAR-->

        <div class="m-product-info">
            <h1 class="a-product-title">Vela de Camomila </h1>
            <p class="a-product-price">R$ 19,00</p>
            
            <div class="o-product-description">
                <h2 class="a-description-title">Benefícios</h2>
                <ul class="m-benefits-list">
                    <li><strong>Calma Profunda:</strong> A camomila é conhecida por suas propriedades relaxantes, ajudando a acalmar a mente e reduzir a agitação emocional.</li>
        <li><strong>Conforto Emocional:</strong> Ideal para momentos de introspecção ou após dias intensos, criando uma atmosfera de acolhimento e serenidade.</li>
        <li><strong>Sono Tranquilo:</strong> Seu aroma suave favorece o descanso, tornando-se uma excelente aliada na rotina noturna.</li>
        <li><strong>Feita com delicadeza:</strong> Produção artesanal com óleos essenciais puros, respeitando a suavidade e a pureza da camomila.</li>
    </ul>

    <p class="a-product-summary">
        Acenda a Vela de Camomila ao final do dia, durante um banho morno ou em momentos de pausa. Seu perfume floral e reconfortante transforma o ambiente em um ninho de tranquilidade e bem-estar.
    </p>
</div>        <!--MUDAR-->
