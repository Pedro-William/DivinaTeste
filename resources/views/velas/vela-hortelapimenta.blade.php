...
<head>
    ...
    <title>Vela Hortelã e Pimenta - Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/vela-hortelapimenta.png" alt="Vela de Hortelã e Pimenta com embalagem Divina Essência" class="a-main-product-image">
        </div>            <!--MUDAR-->

            <!--MUDAR-->

        <div class="m-product-info">
            <h1 class="a-product-title">Vela de Hortelã e Pimenta </h1>
            <p class="a-product-price">R$ 20,50</p>
            
            <div class="o-product-description">
                <h2 class="a-description-title">Benefícios</h2>
                <ul class="m-benefits-list">
                    <li><strong>Despertar Refrescante:</strong> A hortelã estimula os sentidos com seu frescor vibrante, ideal para começar o dia com mais disposição e clareza mental.</li>
                    <li><strong>Foco e Clareza:</strong> A pimenta traz um toque energizante que ajuda a manter a concentração e a produtividade em momentos de estudo ou trabalho.</li>
                    <li><strong>Ambiente Revigorado:</strong> A combinação aromática cria uma atmosfera leve e estimulante, perfeita para renovar a energia do espaço.</li>
                    <li><strong>Toque Artesanal:</strong> Feita manualmente com óleos essenciais puros, garantindo qualidade e cuidado em cada detalhe.</li>
                </ul>
                ...
                <p class="a-product-summary">
                    Acenda a Vela de Hortelã e Pimenta ao iniciar o dia ou durante momentos que pedem foco e renovação. Seu aroma refrescante e estimulante transforma o ambiente em um espaço energizado, ideal para despertar os sentidos e trazer leveza à rotina.
                    </p>
                    </div>
                            <!--MUDAR-->
