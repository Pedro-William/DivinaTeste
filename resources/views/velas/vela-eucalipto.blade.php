...
<head>
    ...
    <title>Vela Eucalipto- Divina Essência</title>
...
<main class="container-principal">
    <section class="o-product-detail">
        ...
        <div class="m-product-gallery">
            <img src="{{ asset('../img/vela-eucalipto.png" alt="Vela de Eucalipto com embalagem Divina Essência" class="a-main-product-image">
        </div>            <!--MUDAR-->

            <!--MUDAR-->

        <div class="m-product-info">
            <h1 class="a-product-title">Vela Eucalipto </h1>
            ...
            <div class="o-product-description">
                ...
                <ul class="m-benefits-list">
                    <li><strong>Respiração Livre:</strong> O aroma do eucalipto ajuda a aliviar a sensação de congestão, proporcionando uma experiência de frescor e leveza.</li>
                    <li><strong>Ambiente Purificado:</strong> Com propriedades naturais que limpam e renovam o ar, é ideal para criar um espaço mais saudável e equilibrado.</li>
                    <li><strong>Estímulo Revigorante:</strong> Perfeita para momentos de cansaço físico ou mental, trazendo uma sensação de energia e renovação.</li>
                    <li><strong>Feita com cuidado:</strong> Produção artesanal com óleos essenciais puros, respeitando a potência natural do eucalipto.</li>
                </ul>
            
                <p class="a-product-summary">
                    Acenda a Vela de Eucalipto durante ou após um banho quente, ou em dias que pedem um alívio imediato e uma atmosfera de frescor medicinal. Ela transforma qualquer cômodo em um ambiente mais leve e purificado.
                </p>
            </div>           <!--MUDAR-->
