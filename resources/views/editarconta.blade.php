...
<head>
    ...
    <title>Editar conta - Divina Essência</title>
    ...
    <link rel="stylesheet" href="css/atomic/atoms/form_elements.css"> 
    <link rel="stylesheet" href="css/atomic/molecules/inputform.css">
    <link rel="stylesheet" href="css/atomic/organisms/layoutform.css">  
...
<body>
 ...
 <div class="container-principal">
        <div class="breadcrumb">
            <a href="#">Home</a> / <span>Editar Conta</span>
        </div>

        <h1 class="titulo-cadastro"> MINHA CONTA</h1>
            ...
            <form action="#" method="POST" class="cadastro-form">
                ...
                <div class="coluna-esquerda">
                    ...
                    <div class="campo-grupo">
                        ...
                        <input type="tel" id="contato" name="contato" placeholder="(XX) XXXXX-XXXX" pattern="\(\d{2}\) \d{5}-\d{4}" required>
                    </div>
                ...
                <div class="coluna-direita">
                    ...
                    <div class="campo-grupo">
                        ...
                        <div class="input-com-icone">
                            <input type="password" id="confirma-senha" name="confirma-senha" placeholder="DIGITE SUA SENHA" required>
                            <i class="fas fa-eye"></i> </div>
                    </div>

                    <div class="opcoes-e-envio">
                        <div class="checkbox-grupo">
                            <input type="checkbox" id="promocionais" name="promocionais">
                            <label for="promocionais">Receber e-mails promocionais</label>
                        </div>

                         <a href="minhaconta.html" class="btn-cadastro">Atualizar</a> 
