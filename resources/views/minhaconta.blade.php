...
<head>
    ...
    <title>Minha Conta - Divina Essência</title>
...
<div class="container-principal">
    <div class="breadcrumb">
        <a href="home.html">Home</a> / <span>Minha Conta</span>
    </div>

    <h1 class="a-section-title o-page-title"> MINHA CONTA</h1>
    ...
    <div class="o-user-dashboard-layout">
        ...
        <div class="o-page-content">
            <h2 class="a-content-subtitle">Dados Pessoais</h2>
            
            <p>Bem-vindo ao seu painel, aqui você pode gerenciar suas informações e acompanhar suas compras.</p>
            
            <div class="m-user-info-card">
                <p><strong>Nome:</strong> [Nome do Usuário]</p>
                <p><strong>E-mail:</strong> [email@exemplo.com]</p>
                <p><strong>Telefone:</strong> [00 00000-0000]</p>
                <button class="a-btn-primary">Editar Dados</button>
            </div>
